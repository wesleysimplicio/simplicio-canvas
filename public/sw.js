const VERSION = 'simplicio-canvas-v2'
const PREVIOUS = 'simplicio-canvas-v1'
self.addEventListener('install', (event) => { event.waitUntil(caches.open(VERSION).then((cache) => cache.addAll([self.registration.scope]))) })
